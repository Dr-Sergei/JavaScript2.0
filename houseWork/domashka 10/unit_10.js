...
let ar3 = ["ggg", 2, 5, true, false, null, 58, 90];
...
let ar4 = ["Nikolai", 2, 5, true, false, null, 58, 90, 888, 10];
...
let ar5 = [4, 23, 55, 16, 85, 34, 77, 2, 7, 2, 4, 8];
...
let ar6 = ["Evgenij", "Strelez", 26, "сентябрь"];
...
function f8() {
  ...
  document.querySelector(".out-8-1").innerHTML = out1;
}
