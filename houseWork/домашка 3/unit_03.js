...
function f1() {
  let info = document.querySelector(".i-1").value;
...
function f3() {
  let info1 = document.querySelector(".i-31");
  let info2 = document.querySelector(".i-32");
  let a3 = +info1.value;
  let b3 = +info2.value;
  let output3 = document.querySelector(".out-3");
  if (a3 > b3) {
    output3.innerHTML = a3;
  } else [(output3.innerHTML = b3)];
}
...
function f4() {
  let myBirthdayYear = +document.querySelector(".i-4").value;
  let myInfo = document.querySelector(".out-4");
  let date = new Date();
  let myAge = date.getFullYear() - myBirthdayYear;
  if (myAge >= 18) {
    myInfo.innerHTML = "1 ";
  } else {
    myInfo.innerHTML = "0";
...
function f6() {
  let input1 = +document.querySelector(".i-6").value;
  let result1 = document.querySelector(".out-6");
  let myNumber = input1 % 2;
...
function f7() {
  let myNumber1 = +document.querySelector(".i-71").value;
  let myNumber2 = +document.querySelector(".i-72").value;
  let myOutput = document.querySelector(".out-7");
  let myResult = Math.pow(myNumber1, myNumber2);
  myOutput.innerHTML = myResult;
}
...
function f8() {
  let mySelect = +document.querySelector(".s-8").value;
  let show = document.querySelector(".out-8");
  switch (mySelect) {
    case 1:
      show.innerHTML = "one";
      break;
...
function f9() {
  let myFaltNumber = +document.querySelector(".i-9").value;
  let showFlatNumber = document.querySelector(".out-9");
  if (myFaltNumber >= 1 && myFaltNumber <= 32) {
    showFlatNumber.innerHTML = "1";
  } else if (myFaltNumber >= 33 && myFaltNumber <= 43) {
    showFlatNumber.innerHTML = "2";
  } else if (myFaltNumber >= 44 && myFaltNumber <= 64) {
    showFlatNumber.innerHTML = "3";
  } else {
    showFlatNumber.innerHTML = "0";
  }
}
...
function f10() {
  let mySelect = document.querySelector(".s-100").value;
  let myScreen = document.querySelector(".out-10");
  myScreen.innerHTML = mySelect;
}
...
function f11() {
  let autoSelect = document.querySelector(".s-110").value;
  let theResult = document.querySelector(".out-11");
  theResult.innerHTML = autoSelect;
}
...
function f13() {
  ...
  let x = i130.value;
  document.querySelector(".out-13").innerHTML = typeof x;
}
//автоматически будет string тк как нигде не указано что это число
...
function f14() {
  let Nr1 = +document.querySelector(".i-141").value;
  let Nr2 = +document.querySelector(".i-142").value;
  let sel = document.querySelector(".s-143").value;
  let text = document.querySelector(".out-14");
  if (sel === "+") {
    text.innerHTML = Nr1 + Nr2;
  } else if (sel === "-") {
    text.innerHTML = Nr1 - Nr2;
  } else if (sel === "/") {
    text.innerHTML = Nr1 / Nr2;
