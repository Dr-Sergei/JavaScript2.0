...
//3-йка является стрингом и происходит конкотенация в число 35 .....console.log(typeof e1)// string
...
function t9() {
  let myValue = document.querySelector(".i-9");
  let b = myValue.value;
  div.innerHTML = b;
  myValue.value = "";
}
...
function t10() {
  let myValue2 = document.querySelector(".i-10");
  let b2 = +myValue2.value;
  div2.innerHTML = b2 * 20;
}
...
function t11() {
  let myVar = document.querySelector(".i-11");
  let b3 = +myVar.value;
  div3.innerHTML = b3 + 55;
  myVar.value = "";
}
...
let nameAndSurname = document.querySelector(".out-12");
function t12() {
  let myName = document.querySelector(".i-12-1").value;
  let mySurname = document.querySelector(".i-12-2").value;
  let together = "Hello" + " " + myName + " " + mySurname;
  nameAndSurname.innerHTML = together;
}
...
let output2 = document.querySelector(".out-16");
...
let output4 = document.querySelector(".out-19");
function t19() {
  let a = document.querySelector(".i-19-1").value;
  let b = document.querySelector(".i-19-2").value;
  let sum4 = Number(a) + Number(b);
  output4.innerHTML = sum4;
}
